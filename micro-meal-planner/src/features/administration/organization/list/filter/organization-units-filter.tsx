...
interface OrganizationUnitsFilterProps {
  page: number;
...
const OrganizationUnitsFilterApp = ({
  page,
  setPage,
  search,
  setSearch,
  ...
  return (
    <div className="organization-units-filter-app">
        ...
        <div className="card-title flex-grow-1">
          ...
          >
            ...
            <input
              ...
              placeholder="Search by organization units name"
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              onKeyDown={(e) => e.key === "Enter" && onSearch()}
              aria-label="Search organizationUnitss"
              tabIndex={0}
              ref={inputRef}
            />
          </div>
        ...
        <div className="card-toolbar flex-row-fluid justify-content-end align-items-center gap-4 mt-3 mt-md-0 position-relative">
          <div className="dropdown">
            <button
              ...
              type="button"
              id="organizationUnitsSortDropdown"
              data-bs-toggle="dropdown"
              aria-expanded="false"
              aria-label="Sort Organization Units"
            >
              {`${start} - ${end} of ${total || 0}`}
            </button>
            <ul
              className="dropdown-menu dropdown-menu-end p-0"
              aria-labelledby="organizationUnitsSortDropdown"
              role="menu"
            >
              <li>
                <button
...
export default OrganizationUnitsFilterApp;
