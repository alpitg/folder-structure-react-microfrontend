...
const InvoiceFilterApp = ({
  ...
  return (
    <div className="Invoice-filter-app">
        ...
        <div className="card-title flex-grow-1">
          ...
          >
            ...
            <input
              ...
              placeholder="Search by invoice number / Invoice code"
              value={search}
        ...
        <div className="card-toolbar flex-row-fluid justify-content-end align-items-center gap-4 mt-3 mt-md-0 position-relative">
          <div className="dropdown">
            ...
            <ul
              ...
              aria-labelledby="InvoiceSortDropdown"
              role="menu"
            >
              <li>
                <button
...
export default InvoiceFilterApp;
